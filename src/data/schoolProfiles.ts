...
export const SCHOOL_PROFILES: Record<SchoolSlug, SchoolProfile> = {
  ...
  cmu: {
    ...
    choiceText: '【北美 CS Top 4】Stanford / MIT / CMU / Berkeley：算法天花板、校友与顶尖大厂/AI 实验室门路最广',
  ...
  ucb: {
    ...
    choiceText: '【北美 CS Top 30】UIUC / UW / UMich / GaTech：扎实工科 + 深厚校友网络',
  ...
  state: {
    ...
    choiceText: '【北美 CS Top 100】SJSU / 普通州立：地处湾区，人脉与实习地利最佳',
  ...
  cn: {
    ...
    masterLabel: '国内 985/211',
    phdLabLabel: '国内 985/211',
    ...
    choiceText: '【国内 985/211】数理算法功底扎实、极度省钱',
