...
console.log('--- [CUJ 8] Save Schema Migration & Deterministic PRNG ---');
{
  ...
  assert(Array.isArray(migrated.gameState.investment_properties), 'Investment properties polyfilled to Array');
  assert(migrated.gameState.rental_income === 0, 'Rental income polyfilled to 0');
  assert(migrated.gameState.fire_tier === 'basic', 'Fire tier polyfilled to basic');
